...
export function SingleCardTiltView({
  ...
  altText,
  rarity,
}: SingleCardTiltViewProps): React.JSX.Element {
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>): void => {
    ...
    // Pure viewport calculations, avoiding DOM layout reads to prevent reflow layout thrashing
    ...
    const cardTop = (wHeight - cardHeight) / 2;
    ...
    >
      ...
      >
        ...
        >
          <div
            ref={cardRef}
            className="card w-[70vw] h-[98vw] md:w-[50vh] md:h-[70vh] cursor-pointer"
