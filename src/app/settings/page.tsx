    ...
    try {
      ...
      if (!response.ok) {
        const errorData = await response
          .json()
          .catch(() => ({ message: `Server responded with ${response.status}` }));
          ...
          <div className="max-w-2xl mx-auto space-y-8">
            <div className="space-y-2 hidden md:block">
              <h1 className="text-3xl font-bold font-headline flex items-center gap-2">
                <SettingsIcon className="h-7 w-7 text-primary" /> Account Settings
              </h1>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage who can follow you and see your collection.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...privacyForm}>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Change the email address associated with your account. This requires your current
                  password.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Change your account password. You will be logged out after a successful change.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...passwordForm}>
