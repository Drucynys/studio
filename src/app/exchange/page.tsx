        ...
        <main className="flex-grow container mx-auto p-4 md:p-8 flex flex-col items-center justify-center min-h-[70vh]">
          <Card className="max-w-md w-full text-center p-8 bg-card border shadow-2xl rounded-2xl relative overflow-hidden">
            ...
            <CardHeader className="items-center pb-2">
              ...
              <CardTitle className="text-2xl font-bold tracking-tight">Collector Exchange</CardTitle>
            ...
            <CardContent className="space-y-4 pt-4">
              <p className="text-sm text-muted-foreground leading-relaxed">
                You must sign in or create an account to view and participate in the public exchange vault.
              </p>
              <Button size="lg" className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 shadow-lg shadow-primary/20" onClick={openAuthModal}>
                Sign In to Explore
              </Button>
            </CardContent>
          </Card>
