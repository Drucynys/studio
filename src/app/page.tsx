...
import { BookOpen, Search, LayoutList, PackageSearch, Camera, Sparkles } from 'lucide-react';
  ...
  const features = [
    {
      title: 'My Collection',
      description:
        'Manage your personal card vault, trace card values, and view detailed statistics about your collection.',
      href: '/my-collection',
    ...
    },
    {
      ...
      description:
        'Instantly query thousands of cards by name, type, rarity, artist, or specific expansion sets.',
      href: '/search',
    ...
    },
    {
      title: 'Browse Sets',
      description:
        'Explore all official Pokémon TCG expansions in numerical order with our smooth infinite scroll gallery.',
      href: '/browse-sets',
    ...
    },
    {
      ...
      description:
        'Track your species ownership progress across Gen 1 to Gen 9. Complete your National Dex!',
      href: '/pokedex',
    ...
    },
    {
      ...
      description:
        'Scan card artwork using your device camera or upload an image to identify and catalog cards instantly.',
      href: '/add-card',
    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow container mx-auto p-4 md:p-8 space-y-12">
        ...
        <section
          ...
          className="relative overflow-hidden text-center p-8 md:p-12 bg-gradient-to-br from-card to-card/90 border shadow-2xl rounded-2xl"
        >
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            ...
            Track market values, complete historic sets, and fulfill your dream of a complete
            National Pokédex.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            {user ? (
              ...
              <>
                <Button
                  size="lg"
                  className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 shadow-lg shadow-primary/20 w-full sm:w-auto"
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-primary/20 text-primary hover:bg-primary/5 font-semibold px-8 w-full sm:w-auto"
        ...
        <section className="space-y-6">
          <div className="text-center md:text-left space-y-1 px-2">
            ...
            <p className="text-muted-foreground">
              Every tool you need to complete your master set.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature) => (
              <Link href={feature.href} key={feature.title} className="block group">
                <div
                  className={`h-full p-6 bg-card border rounded-xl transition-all duration-300 transform group-hover:-translate-y-1 shadow-md hover:shadow-xl flex flex-col justify-between ${feature.color}`}
                >
