...
patch('src/app/page.tsx', [
  [
    'const { user, openAuthModal, collection, loginAsDemoGuest } = useAuth();',
    'const { user, collection, loginAsDemoGuest } = useAuth();\n  const { openAuthModal } = useUIStore();',
  ],
]);
...
patch('src/app/friends/page.tsx', [
  [
    ...
    'const { user, following, loadingFollowing } = useAuth();\n    const { openAuthModal } = useUIStore();',
  ],
]);
...
patch('src/components/AuthModal.tsx', [
  [
    'const { isAuthModalOpen, closeAuthModal, signUp, signIn, signInWithGoogle, loginAsDemoGuest } = useAuth();',
...
patch('src/components/AddCardToCollectionDialog.tsx', [
  [
    'const { user, addCardToCollection, removeCardFromCollection, addCardToWishlist, removeCardFromWishlist, openAuthModal, collection, wishlist } = useAuth();',
    'const { user, addCardToCollection, removeCardFromCollection, addCardToWishlist, removeCardFromWishlist, collection, wishlist } = useAuth();\n  const { openAuthModal } = useUIStore();',
  ],
]);
